...
import bai_ly_thuyet.quan_ly_code_gym.service.IStudentService;
import bai_ly_thuyet.quan_ly_code_gym.service.StudentService;
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    LocalDate date = LocalDate.parse(scanner.nextLine());
                    if (date != null) {
                        CurrentStudent.setDateOfBirth(date);
                    }
                    break;
                case 3:
